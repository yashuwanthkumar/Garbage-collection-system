...
<head>
    <meta charset="utf-8">
    <title> GARBAGE COLLECTION SYSTEM|| Home Page</title>
...
{               ?>      
        <div class="row gx-0 d-none d-lg-flex">
            ...
            <div class="col-lg-5 px-5 text-end">
                ...
                <div class="h-100 d-inline-flex align-items-center">
                    <a class="btn btn-sm-square bg-white text-primary me-1" href="https://www.facebook.com/yashu.kn.5?mibextid=ZbWKwL"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-sm-square bg-white text-primary me-0" href="https://www.instagram.com/s_wanth_21?igsh=czNrNW41MG54YmY0"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
    <?php $cnt=$cnt+1;}} ?></div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">GARBAGE COLLECTION SYSTEM </h2>
        </a>
    ...
    <div class="container-fluid p-0 pb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img1/gb2.jpg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome To GARBAGE COLLECTION SYSTEM </h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Garbage Collection Services</h1>
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img1/gb7.jpg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img1/gb3.jpg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">GARBAGE COLLECTION SYSTEM</a>, All Right Reserved.
                    </div>
